...
namespace StudentManagement {
    ...
    public partial class StudentDBDataSet3 : global::System.Data.DataSet {
        ...
        public partial class CourseDataTable : global::System.Data.TypedTableBase<CourseRow> {
            ...
            [global::System.Diagnostics.DebuggerNonUserCodeAttribute()]
            [global::System.CodeDom.Compiler.GeneratedCodeAttribute("System.Data.Design.TypedDataSetGenerator", "17.0.0.0")]
            public CourseRow AddCourseRow(int CourseId, string Course, string Duration) {
...
namespace StudentManagement.StudentDBDataSet3TableAdapters {
    ...
    public partial class CourseTableAdapter : global::System.ComponentModel.Component {
        ...
        private void InitAdapter() {
            ...
            this._adapter.DeleteCommand.CommandText = "DELETE FROM [dbo].[Course] WHERE (([CourseId] = @Original_CourseId) AND ((@IsNull" +
                "_Course = 1 AND [Course] IS NULL) OR ([Course] = @Original_Course)) AND ((@IsNul" +
                "l_Duration = 1 AND [Duration] IS NULL) OR ([Duration] = @Original_Duration)))";
            ...
            this._adapter.UpdateCommand.CommandText = @"UPDATE [dbo].[Course] SET [CourseId] = @CourseId, [Course] = @Course, [Duration] = @Duration WHERE (([CourseId] = @Original_CourseId) AND ((@IsNull_Course = 1 AND [Course] IS NULL) OR ([Course] = @Original_Course)) AND ((@IsNull_Duration = 1 AND [Duration] IS NULL) OR ([Duration] = @Original_Duration)));
SELECT CourseId, Course, Duration FROM Course WHERE (CourseId = @CourseId)";
        ...
        private void InitCommandCollection() {
            ...
            this._commandCollection[0].CommandText = "SELECT CourseId, Course, Duration FROM dbo.Course";
        ...
        public virtual int Fill(StudentDBDataSet3.CourseDataTable dataTable) {
        ...
        public virtual StudentDBDataSet3.CourseDataTable GetData() {
            this.Adapter.SelectCommand = this.CommandCollection[0];
            StudentDBDataSet3.CourseDataTable dataTable = new StudentDBDataSet3.CourseDataTable();
        ...
        [global::System.CodeDom.Compiler.GeneratedCodeAttribute("System.Data.Design.TypedDataSetGenerator", "17.0.0.0")]
        [global::System.ComponentModel.Design.HelpKeywordAttribute("vs.data.TableAdapter")]
        public virtual int Update(StudentDBDataSet3.CourseDataTable dataTable) {
        ...
        public virtual int Delete(int Original_CourseId, string Original_Course, string Original_Duration) {
        ...
        public virtual int Insert(int CourseId, string Course, string Duration) {
        ...
        public virtual int Update(int CourseId, string Course, string Duration, int Original_CourseId, string Original_Course, string Original_Duration) {
            ...
            if ((Original_Course == null)) {
                ...
                this.Adapter.UpdateCommand.Parameters[5].Value = ((string)(Original_Course));
            }
            if ((Original_Duration == null)) {
        ...
        [global::System.ComponentModel.Design.HelpKeywordAttribute("vs.data.TableAdapter")]
        [global::System.ComponentModel.DataObjectMethodAttribute(global::System.ComponentModel.DataObjectMethodType.Update, true)]
        public virtual int Update(string Course, string Duration, int Original_CourseId, string Original_Course, string Original_Duration) {
            return this.Update(Original_CourseId, Course, Duration, Original_CourseId, Original_Course, Original_Duration);
        }
    }
