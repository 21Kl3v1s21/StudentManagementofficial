...
namespace StudentManagement {
    ...
    public partial class StudentDBDataSet : global::System.Data.DataSet {
        ...
        public partial class StudentDataTable : global::System.Data.TypedTableBase<StudentRow> {
            ...
            [global::System.Diagnostics.DebuggerNonUserCodeAttribute()]
            [global::System.CodeDom.Compiler.GeneratedCodeAttribute("System.Data.Design.TypedDataSetGenerator", "17.0.0.0")]
            public StudentRow AddStudentRow(int StudentId, string StudentName, string Phone, string Email) {
...
namespace StudentManagement.StudentDBDataSetTableAdapters {
    ...
    public partial class StudentTableAdapter : global::System.ComponentModel.Component {
        ...
        private void InitAdapter() {
            ...
            this._adapter.DeleteCommand.CommandText = @"DELETE FROM [dbo].[Student] WHERE (([StudentId] = @Original_StudentId) AND ((@IsNull_StudentName = 1 AND [StudentName] IS NULL) OR ([StudentName] = @Original_StudentName)) AND ((@IsNull_Phone = 1 AND [Phone] IS NULL) OR ([Phone] = @Original_Phone)) AND ((@IsNull_Email = 1 AND [Email] IS NULL) OR ([Email] = @Original_Email)))";
            ...
            this._adapter.InsertCommand.CommandText = "INSERT INTO [dbo].[Student] ([StudentId], [StudentName], [Phone], [Email]) VALUES" +
                " (@StudentId, @StudentName, @Phone, @Email);\r\nSELECT StudentId, StudentName, Pho" +
                "ne, Email FROM Student WHERE (StudentId = @StudentId)";
            ...
            this._adapter.UpdateCommand.CommandText = @"UPDATE [dbo].[Student] SET [StudentId] = @StudentId, [StudentName] = @StudentName, [Phone] = @Phone, [Email] = @Email WHERE (([StudentId] = @Original_StudentId) AND ((@IsNull_StudentName = 1 AND [StudentName] IS NULL) OR ([StudentName] = @Original_StudentName)) AND ((@IsNull_Phone = 1 AND [Phone] IS NULL) OR ([Phone] = @Original_Phone)) AND ((@IsNull_Email = 1 AND [Email] IS NULL) OR ([Email] = @Original_Email)));
SELECT StudentId, StudentName, Phone, Email FROM Student WHERE (StudentId = @StudentId)";
        ...
        private void InitCommandCollection() {
            ...
            this._commandCollection[0].CommandText = "SELECT StudentId, StudentName, Phone, Email FROM dbo.Student";
        ...
        public virtual int Delete(int Original_StudentId, string Original_StudentName, string Original_Phone, string Original_Email) {
        ...
        public virtual int Insert(int StudentId, string StudentName, string Phone, string Email) {
        ...
        public virtual int Update(int StudentId, string StudentName, string Phone, string Email, int Original_StudentId, string Original_StudentName, string Original_Phone, string Original_Email) {
        ...
        [global::System.ComponentModel.Design.HelpKeywordAttribute("vs.data.TableAdapter")]
        [global::System.ComponentModel.DataObjectMethodAttribute(global::System.ComponentModel.DataObjectMethodType.Update, true)]
        public virtual int Update(string StudentName, string Phone, string Email, int Original_StudentId, string Original_StudentName, string Original_Phone, string Original_Email) {
            return this.Update(Original_StudentId, StudentName, Phone, Email, Original_StudentId, Original_StudentName, Original_Phone, Original_Email);
        }
    }
